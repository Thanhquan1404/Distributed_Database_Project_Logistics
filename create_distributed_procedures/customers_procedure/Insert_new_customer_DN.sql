...
BEGIN
    ...
    IF v_region = 'DN' THEN
        ...
        VALUES (v_Customer_ID, v_Customer_Name, v_City, v_Customer_Rating, 'DN');
    ELSIF v_region = 'HN' THEN
        INSERT INTO Customers@MinhThuy_Oracle_DistributedDatabase (Customer_ID, Customer_Name, City, Customer_Rating, Created_By)
        VALUES (v_Customer_ID, v_Customer_Name, v_City, v_Customer_Rating, 'DN');
    ELSE -- HCM
...
EXEC Insert_Customer('CUSDN001', 'Nguyễn Văn Tèo', 'Hội An', 4);
EXEC Insert_Customer('CUSDN002', 'Trần Thị Kim ', 'Quảng Ngãi', 4);
EXEC Insert_Customer('CUSDN003', 'Nguyễn Huy Hoàng', 'Tam Kỳ', 4);
