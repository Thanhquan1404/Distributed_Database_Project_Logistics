...
AS
    ...
    v_hcm_exists NUMBER;
BEGIN
    SELECT COUNT(*) INTO v_dn_exists FROM Products WHERE Product_ID = v_Product_ID;
    ...
    VALUES (v_Product_ID, v_Product_Name, v_Product_Weight, v_Cost_Of_Product, v_Rating, 'DN');
    ...
    INSERT INTO Products@KimNgan_Oracle_DistributedDatabase (Product_ID, Product_Name, Weight, Cost_Of_Product, Rating, Created_By)
    VALUES (v_Product_ID, v_Product_Name, v_Product_Weight, v_Cost_Of_Product, v_Rating, 'DN');
